...
public class Test03b_SchedObserveOn {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Observable.just(100)
            ...
            .observeOn(Schedulers.computation()) 					// => use RX computation thread(s) downstream
            .map(v -> { log("map 2 " + v); return v + 1; })	// by the RX computation thread
            .subscribe(v -> log("sub " + v));					// by the RX computation thread
