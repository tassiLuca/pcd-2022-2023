...
public class CounterGUI extends JFrame implements ActionListener, CounterEventListener {
    ...
    public CounterGUI(Counter c, Controller contr){
        ...
        display.setText(String.valueOf(c.getValue()));
    ...
    public void counterChanged(final CounterEvent ev){
        SwingUtilities.invokeLater(()-> {
            display.setText(String.valueOf(ev.getValue()));
        });
    }
